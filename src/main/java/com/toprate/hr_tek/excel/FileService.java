package com.toprate.hr_tek.excel;


import com.toprate.hr_tek.model.*;
...
//                Nếu có lỗi gì sẽ đáp vào listError
    ...
    private boolean checkPhone(String phone){
        ...
        if(phone == null || phone.equals("")){
            ...
            // check gmail 1 có chưa
            String findGmail1 = contactService.getContactPhone_1(phone).getPhone1();
            String findGmail2 = contactService.getContactPhone_2(phone).getPhone2();
